...
export function renderWidget(w: WidgetInstance) {
  switch (w.type) {
    ...
    case 'agent-usage': return <AgentUsageWidget />;
...
export const WIDGET_CATALOG: { type: WidgetInstance['type']; name: string; emoji: string }[] = [
  ...
  { type: 'system', name: '系统占用', emoji: '💻' },
  { type: 'news', name: '新闻', emoji: '📰' },
  { type: 'music', name: '音乐播放器', emoji: '🎵' },
  { type: 'chat', name: 'AI 聊天', emoji: '💬' },
  { type: 'agent-usage', name: 'AI 用量', emoji: '📊' },
];
